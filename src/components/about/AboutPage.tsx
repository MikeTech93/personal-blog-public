...
const EXPERIENCE: Experience[] = [
  {
    ...
    current: true,
    bullets: [
      'Architect and maintain cloud infrastructure across Azure and AWS for client environments',
      'Lead Terraform adoption for infrastructure-as-code across multiple projects',
      'Build and maintain CI/CD pipelines using Azure DevOps and GitHub Actions',
      'Implement Kubernetes-based workloads with Docker and container orchestration',
      'Automate operational tasks using Python, PowerShell and Bash scripting',
      'Work with data platforms including Snowflake, Elasticsearch and OpenSearch',
    ],
    tags: ['Azure', 'AWS', 'Terraform', 'Kubernetes', 'Azure DevOps', 'Python'],
  },
  {
    ...
    period: '2014 - 2018',
    bullets: [
      'Managed on-premise and hybrid cloud infrastructure across Windows and Linux environments',
      'Developed automation scripts in PowerShell and Bash to reduce manual operational overhead',
      'Deployed and maintained web application infrastructure including SQL and MySQL databases',
      'Supported development teams with environment provisioning and tooling',
    ],
    tags: ['Windows', 'Linux', 'PowerShell', 'SQL', 'MySQL', 'Bash'],
  },
  {
    ...
    period: '2009 - 2014',
    bullets: [
      'Provided technical support and systems administration across Windows and Unix environments',
      'Gained foundational experience in networking, server management and end-user support',
      'Completed apprenticeship programme earning CompTIA A+, CompTIA Network+ and Microsoft MCTS certifications',
    ],
    tags: ['Windows', 'Unix', 'Networking', 'CompTIA A+', 'CompTIA Network+'],
  },
]
...
const SKILLS: Skill[] = [
  ...
  { label: 'Azure DevOps', color: 'border-blue-400/30 hover:border-blue-300/60' },
  { label: 'Python', color: 'border-yellow-500/30 hover:border-yellow-400/60' },
  { label: 'Docker', color: 'border-blue-500/30 hover:border-blue-400/60' },
  { label: 'Kubernetes', color: 'border-blue-400/30 hover:border-blue-300/60' },
  { label: 'JavaScript', color: 'border-yellow-400/30 hover:border-yellow-300/60' },
  { label: 'C#', color: 'border-purple-400/30 hover:border-purple-300/60' },
  { label: 'PowerShell', color: 'border-blue-400/30 hover:border-blue-300/60' },
  { label: 'Terraform', Icon: TerraformIcon, color: 'border-purple-500/30 hover:border-purple-400/60' },
  { label: 'Bash', color: 'border-slate-400/30 hover:border-slate-300/60' },
  { label: 'Snowflake', color: 'border-cyan-400/30 hover:border-cyan-300/60' },
  { label: 'SQL', color: 'border-orange-400/30 hover:border-orange-300/60' },
  { label: 'MySQL', color: 'border-orange-300/30 hover:border-orange-200/60' },
  { label: 'Adobe Connect', color: 'border-red-400/30 hover:border-red-300/60' },
  { label: 'Elasticsearch', color: 'border-yellow-500/30 hover:border-yellow-400/60' },
  { label: 'OpenSearch', color: 'border-blue-300/30 hover:border-blue-200/60' },
  { label: 'Linux', color: 'border-yellow-400/30 hover:border-yellow-300/60' },
  { label: 'Windows', color: 'border-blue-300/30 hover:border-blue-200/60' },
  { label: 'Unix', color: 'border-slate-400/30 hover:border-slate-300/60' },
